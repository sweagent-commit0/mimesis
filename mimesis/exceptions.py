...
class SchemaError(ValueError):
    ...
    def __str__(self) -> str:
        return 'The schema must be a callable object that returns a dict.See https://mimesis.name/en/master/schema.html for more details.'
...
class AliasesTypeError(TypeError):
    ...
    def __str__(self) -> str:
        return "The 'aliases' attribute needs to be a non-nested dictionary where keys are the aliases and values are the corresponding field names."